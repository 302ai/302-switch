    ...
    try {
      ...
      if (!displayVersion) {
        await settingsApi.openExternal(
          "https://github.com/302ai/302-cc-switch/releases",
        );
        return;
      }

      await settingsApi.openExternal(
        `https://github.com/302ai/302-cc-switch/releases/tag/${displayVersion}`,
      );
    } catch (error) {
          ...
          <div className="flex items-center gap-8">
            <div className="flex flex-col items-center gap-2">
              <div className="flex items-center gap-2">
                <img src={appIcon} alt="302 Switch" className="h-5 w-5" />
            ...
            <Button
              ...
              onClick={() =>
                settingsApi.openExternal(
                  "https://github.com/302ai/302-cc-switch",
                )
              }
              className="h-8 gap-1.5 text-xs"
            >
